...
class Bootloader:
    def __init__(self):
        ...
        if self.runos.lower() == "yes" or self.runos.lower() == "y":
            print("kernel4.0")
            print("kernel4.0.1beta")
            kernelselect = input("select the kernel > ")
            if kernelselect == "kernel4.0":
                Kernel4_0()
            elif kernelselect == "kernel4.0.1beta":
                print("this kernel is the 4.1 beta but it's named 4.0.1 beta. Some things here will be added only in 4.1")
                Kernel4_0_1beta()
...
print('Kernel4.0                   # is the pythonOS kernel')
...
print("Kernel loaded by PythonOS Bootloader")"""}
    ...
    def RunOS(self):
        print("+------------------------------+")
        print("|                              |")
        print("|  pythonOS 4.0 by jose icaro  |")
        ...
        while True:
            ...
            if command.startswith("print"):
                ...
                print("pythonOS by jose icaro. version: 4.0")
...
class Kernel4_0_1beta:
    def __init__(self):
        ...
        self.memory_path = f"{memory_path_1}pythonOSmem.txt"
        self.packages = {"ptop": """print('--> processes occurring:')
print('Kernel4.0.1 beta            # System Kernel')
print('evig                        # System Commands')
print('Bootloader                  # System bootloader')
print('pypackage                   # packages system')
print('--> about processes occurring:')
print('Kernel4.0.1 beta            # is the pythonOS kernel')
print('evig                        # all the commands')
print("Bootloader                  # is the bootloader who loads the kernel that runs while you're running the system")
print("pypackage                   # pythonOS package manager system")
print("--> installed packages:")
for package in self.packages:
    print(package)""",
        "kernel": """print("Kernel4.0.1beta")
print("PythonOS kernel beta")
print("Kernel loaded by PythonOS Bootloader")"""}
        self.foodcount = 0
        if self.computername.lower() == "nothing":
            self.computername = "pythonOS"
    ...
    def RunOS(self):
        ...
        while True:
            ...
            if command.startswith("print"):
                ...
                print("pypackage-listinstalled                          : list of all the installed .py file packages")
                print("pypackage-packagecode <installed-package-name>   : shows the code of the installed package")
                print("code <directory>                                 : open the directory with vscode (you need to have it installed)")
                print("more commands coming soon in 4.1 kernel...")
            elif command.startswith("clr"):
                self.clear_screen()
            elif command.startswith("dl"):
                self.list_directory()
